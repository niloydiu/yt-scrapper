  ...
  <body>
    <div class="container">
      <header>
        ...
        <h1>YouTube Pro</h1>
        <p class="subtitle">Extract high-fidelity metadata (50+ fields) from channels, playlists, or single videos — including tags, categories, view counts, durations, and high-resolution thumbnails. Export clean, validated JSON for research, analytics, or importing into apps and databases.</p>
        
        <!-- features moved below the main input card to keep the input visible on small screens -->
      </header>
      ...
      <!-- Features (moved here so the main input stays visible) -->
      <div class="features" style="margin-bottom:40px;">
          <div class="feature-card">
            <div class="feature-icon"><i class="bi bi-lightning-charge"></i></div>
            <h3>Deep Metadata</h3>
            <p>Harvest 50+ high-fidelity fields per video (title, description, tags, category, views, likes, duration, upload date, and multiple thumbnail sizes) for accurate analysis.</p>
          </div>
          <div class="feature-card">
            <div class="feature-icon"><i class="bi bi-filetype-json"></i></div>
            <h3>Clean Export</h3>
            <p>Export validated JSON files with consistent schemas and IDs — ready for ingestion into databases, analytics pipelines, or recipe managers.</p>
          </div>
      </div>
